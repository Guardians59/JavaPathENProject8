...
public class DB {
	...
	public void initializeInternalUsers() {
		IntStream.range(0, InternalTesterHelper.getInternalUserNumber()).forEach(i -> {
		...
		logger.debug("Created " + InternalTesterHelper.getInternalUserNumber() + " internal test users.");
	}
